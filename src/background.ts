...
const players: Player[] = [
  ...
  {
    controlQueries: {
      next: ".control.control-next, .player-controls .svg-icon-group-item:nth-of-type(5) button",
      play: ".control.control-play, .player-controls .svg-icon-group-item:nth-of-type(3) button",
